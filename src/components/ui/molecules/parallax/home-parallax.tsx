...
const MultiLayerParallax = ({ parallaxContent }: ParallaxComponentProps) => {
  ...
  return (
    <section className="relative h-screen overflow-hidden">
      ...
      <div
        className="absolute bottom-0 md:bottom-4 xl:bottom-16 3xl:bottom-20 left-1/2 w-[100vw] md:w-[80vw] 2xl:w-[100vw] max-w-xl 2xl:max-w-3xl 3xl:max-w-5xl z-0 pointer-events-none max-[900px]:landscape:hidden"
        style={{
