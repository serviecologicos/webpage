...
import ChooseUsSection from "../../molecules/section/choose-us-section";
import CTASection from "../../molecules/section/cta-section";
...
export default function ContentSection({ sectionContent }: SectionComponentProps) {
  const { background } = sectionContent;
  const backgroundImage = background.media.url;
  return(
    <>
      <ServiceSection backgroundImage={backgroundImage} />
      <ChooseUsSection />
      <CTASection />
    </>
  )
